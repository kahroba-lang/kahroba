...
با این حداقل کاراکتر های معنا دار توکن گفته مبیشود
...
/*
نوع داده جدیدی برای تشخصی نوع توکن تعریف میکنیم تا کد ما خوانایی بیشتری داشته باشد
*/
type Type string
...
یک مپ قرار میدهیم تا به وسیله آن راحت تر بتوانیم نوع کلمه را تشخصی بدهیم
...
کار را پیش ببرد
در فایل بعدی با پارسر آشنا میشویم ولی فقط در این حد بدانید که خروجی لکسر توسط پارسر پرداز میشود.
پس اگر توکن ها را درون آرایه قرار دهیم تا بایان پردازش رشته پارسر نمیتواند آن را پردازش کند
...
تا وقتی به یک کاراکتر غیر حرف برخورد نکرده ایم به خوانن ادامه میدهیم
...
و توکن بعدی یک توکن از نوع رنج یا دونطقه است
*/
