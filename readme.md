...
برای اجرای برنامه های به زبان کهربا لازم است برنامه خود را در فایلی با پسوند .kahroba یا .krb بسازید (مانند main.kahroba یا main.krb) و از خط فرمان برنامه را اجرا کنید:  
