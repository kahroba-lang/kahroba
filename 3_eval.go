...
مربوط به آن نود در زبان زبان مبدا را مشخص کنیم که اینجا زبان مبدا گو هست
همه نود ها اینترفیس
Node
...
نگهداری فانکشن ها. البته میشود از یک مپ هم استفاده کرد ولی در آنصورت نمیتوان فانکشن همنام با یک متغیر درون یک اسکوپ داشت باشیم
کاری که گو اجازه آن را نمی‌دهد ولی ما دذ کهربا میتونیم یک فانکشن هم نام با یک متغیر داشته باشیم :) ‌ـ
*/
type Scope struct {
...
/*
دستورات شرطی هم به راحتی قابل محاسبه هسنتند
